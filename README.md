...
Плагин для Minecraft (Paper 1.21+), который автоматически спавнит процедурные данжи из WorldEdit-схем (`.schem`) в открытом мире. Данжи защищаются WorldGuard-регионами, содержат шалкеры с лутом и требуют ключ для открытия.
